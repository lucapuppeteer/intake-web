...
- **Phone-based intake** — Voice AI platforms like [PuppeteerAI](https://puppeteerai.com) extend this to phone-based intake, handling inbound patient calls with HIPAA-compliant voice agents for scheduling and triage.
