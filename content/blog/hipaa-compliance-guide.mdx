...
- Do they handle phone-based patient interactions? Voice AI platforms like [PuppeteerAI](https://puppeteerai.com) specialize in HIPAA-compliant voice agents for inbound calls, with the same BAA and encryption standards required of any AI tool handling PHI.
