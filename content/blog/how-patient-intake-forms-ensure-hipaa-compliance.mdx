...
- **Phone-based compliance** — For practices that collect intake information over the phone, [PuppeteerAI](https://puppeteerai.com) extends these same HIPAA-compliant safeguards to voice interactions, ensuring inbound patient calls are handled with the same level of data protection as digital forms.
