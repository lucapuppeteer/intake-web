...
- **Voice AI support** — For practices with high call volumes, voice AI platforms like [PuppeteerAI](https://puppeteerai.com) extend automation to inbound phone intake calls — answering every call instantly, collecting structured data conversationally, and routing complex cases to staff.
